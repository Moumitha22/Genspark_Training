...
namespace ClinicManagementSystem.Migrations
{
    ...
    [Migration("20250605063728_AddFileFormatsTable")]
    partial class AddFileFormatsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicManagementSystem.Models.DTOs.DoctorsBySpecialityResponseDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ClinicManagementSystem.Models.DoctorSpeciality", b =>
                {
            ...
            modelBuilder.Entity("ClinicManagementSystem.Models.FileFormat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ClinicManagementSystem.Models.Speciality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ClinicManagementSystem.Models.Doctor", b =>
                {
                    b.HasOne("ClinicManagementSystem.Models.User", "User")
                        .WithOne("Doctor")
                        .HasForeignKey("ClinicManagementSystem.Models.Doctor", "Email")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("ClinicManagementSystem.Models.DoctorSpeciality", b =>
                {
                    ...
                    b.HasOne("ClinicManagementSystem.Models.Speciality", "Speciality")
                        .WithMany("DoctorSpecialities")
            ...
            modelBuilder.Entity("ClinicManagementSystem.Models.Patient", b =>
                {
                    b.HasOne("ClinicManagementSystem.Models.User", "User")
                        .WithOne("Patient")
                        .HasForeignKey("ClinicManagementSystem.Models.Patient", "Email")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
