...
namespace ClinicManagementSystem.Controllers
{
    ...
    public class DoctorController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<DoctorResponseDto>> AddDoctor([FromBody] DoctorAddRequestDto doctorDto)
        {
            try
            {
        ...
        public async Task<ActionResult<ICollection<DoctorResponseDto>>> GetDoctorsBySpeciality(string speciality)
        {
            try
            {
