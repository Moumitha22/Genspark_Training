...
namespace PropFinderApi.Repositories
{
    public class UserRepository : Repository<Guid, User>, IUserRepository
    {
        ...
        {
            var user = await _propFinderDbContext.Users.SingleOrDefaultAsync(u => u.Id == id);
        ...
        public async Task<User?> GetByEmailandRoleAsync(string email, UserRole role)
        {
            return await _propFinderDbContext.Users
