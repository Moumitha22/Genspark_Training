...
namespace PropFinderApi.Models.DTOs
{
    public class PropertyAddRequestDto
    {
        ...
        [EnumDataType(
            typeof(ListerType),
            ErrorMessage = "Invalid property type. Property type can be Apartment, House, Villa, Plot or Commercial"
        )]
        ...
        [EnumDataType(
            typeof(PropertyType),
            ErrorMessage = "Invalid lister type. Lister type can eiher be 'Agent' or 'Owner'"
        )]
        public PropertyType PropertyType { get; set; }

        [Required(ErrorMessage = "Property listing type is required.")]
        [EnumDataType(
            typeof(ListingPurpose),
            ErrorMessage = "Invalid property listing purpose. Listing purpose can either be 'Sale' or 'Rent'"
        )]
        ...
        public List<Guid> DiscountCodeIds { get; set; } = new List<Guid>();
