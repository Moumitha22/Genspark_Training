...
//         [Test]
//         public async Task CreateProperty_ReturnsOkResponse_WhenLister()
//         {
//             var userId = Guid.NewGuid();
//             SetUserContext(userId, "Lister");
...
//         [Test]
//         public async Task UpdateProperty_ReturnsOk_WhenListerOwnsProperty()
//         {
//             var propertyId = Guid.NewGuid();
//             var listerId = Guid.NewGuid();
//             SetUserContext(listerId, "Lister");
...
//                 .Setup(s => s.UpdatePropertyAsync(propertyId, updateDto, listerId, "Lister"))
...
//             _propertyServiceMock.Verify(s => s.UpdatePropertyAsync(propertyId, updateDto, listerId, "Lister"), Times.Once);
//         }
...
//             _propertyServiceMock.Verify(s => s.DeletePropertyAsync(id, userId, "Lister"), Times.Once);
//             Assert.That(result, Is.InstanceOf<OkObjectResult>());
//             var okResult = result as OkObjectResult;
//             Assert.IsNotNull(okResult);
