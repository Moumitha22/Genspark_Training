...
//   onUpdate(featureId: string, updatedData: any): void {
//     this.featureService.updateFeature(featureId, updatedData).subscribe({
//       next: (res) => {
//         this.notificationService.success('Feature updated successfully.');
//         this.loadFeatures(); 
//       },
//       error: () => {
//         this.notificationService.error('Failed to update feature.');
//       }
//     });
//   }
