...
{
    public class ListerProfileMapper
    {
        public ListerProfile MapListerProfileRequestDtoToListerProfile(ListerProfileAddRequestDto dto, Guid userId)
        {
            var sanitizedLicenseNumber = SanitizeLicenseNumber(dto.LicenseNumber);
            return new ListerProfile
            {
                Id = Guid.NewGuid(),
                UserId = userId,
        ...
        public ListerProfile MapUpdatedListerProfile(ListerProfile existing, ListerProfileAddRequestDto dto)
        {
